...
ActiveRecord::Schema.define(version: 2021_12_22_182015) do
  ...
  create_table "tests", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "author_id"
    t.boolean "possibility_of_passing", default: false
    t.time "timer"
  ...
  create_table "users", force: :cascade do |t|
    t.string "first_name", default: "User first name", null: false
    t.string "last_name", default: "User last name", null: false
    t.string "email"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
